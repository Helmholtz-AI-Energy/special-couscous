#!/usr/bin/env python
"""Serial random forest classification of a given dataset in `specialcouscous``."""

import logging
import pathlib

from specialcouscous.train.train_serial import train_serial_on_dataset
...
if __name__ == "__main__":
    ...
    log.info(
        "**********************************************************\n"
        "* Serial Random Forest Classification on A Given Dataset *\n"
        "**********************************************************\n"
