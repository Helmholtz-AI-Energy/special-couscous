...
N_SAMPLES=1000000
N_FEATURES=10000
N_TREES=76  # We estimated 1500 trees should be trainable in serial in 3 d and chose the closest number evenly divisble by 64 as a baseline for scaling exps.

SCRIPT="rf_scaling_synthetic.py"

RESDIR=/hkfs/work/workspace/scratch/ku4408-special-couscous/results/strong_scaling/n6_m4_${SLURM_JOB_ID}_test_acc/
mkdir ${RESDIR}
cd ${RESDIR}
