#!/bin/bash
#SBATCH --job-name=n7_m3_test_acc     # job name
...
N_SAMPLES=10000000
N_FEATURES=1000
N_TREES=76  # We estimated 450 trees to be trainable in serial in 3 days and chose the next smaller number evenly divisible by 64 (scaling experiments).

SCRIPT="rf_serial_synthetic.py"

RESDIR=/hkfs/work/workspace/scratch/ku4408-special-couscous/results/strong_scaling/job_${SLURM_JOB_ID}_n7_m3_test_acc/
mkdir ${RESDIR}
cd ${RESDIR}
